...
const lessonProblem1 = {
  type: "SELECT_1_OF_3",
  question: `¿Khitis uka warmixa?`,
  answers: [
    { icon: <AppleSvg />, name: "La Manzana" },
    { icon: <BoySvg />, name: "El Chico" },
...
const lessonProblem2 = {
  ...
  question: "Mi nombre es Llama",
  answerTiles: ["Nayan ", "Llama", "sutijax", "I", "The", "boy"],
  correctAnswer: [0, 2, 1],
} as const;
            ...
            {isAnswerCorrect ? (
              ...
              <div className="mb-2 flex flex-col gap-5 sm:flex-row sm:items-center">
                ...
                <div className="flex flex-col gap-2">
                  <div className="text-2xl">Solucion Correcta:</div>{" "}
  ...
  return (
    ...
    >
      ...
      <div className="relative flex w-full max-w-4xl flex-col gap-5 rounded-2xl border-2 border-gray-200 bg-white p-8">
        ...
        <h2 className="text-center text-3xl">¡Mira tus puntos!</h2>
        <p className="text-center text-xl text-gray-400">
          Haga clic para revelar las soluciones.
        </p>
    ...
    <div className="flex min-h-screen flex-col px-5 py-8 text-center">
      <div className="flex grow flex-col items-center justify-center gap-5">
        ...
        <h1 className="text-lg font-bold">
         Quiere saltar a la unidad {unitNumber}?
        </h1>

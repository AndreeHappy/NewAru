  ...
  return (
    <article className="relative hidden h-fit w-96 shrink-0 gap-5 rounded-2xl border-2 border-gray-200 p-6 xl:flex">
      <div className="flex flex-col gap-5">
        ...
        <p className="font-bold text-gray-700">Hacer lecciones. Gana XP. Competir.</p>
        <p className="text-gray-400">
         Gana XP a través de lecciones y luego compite con jugadores en una tabla de clasificación semanal
        </p>
      </div>
          ...
          {!leaderboardIsUnlocked && (
            <>
              ...
              <h1 className="text-center text-2xl font-bold text-gray-700">
                ¡Desbloquea tablas de clasificación!
              </h1>
              <p className="text-center text-lg text-gray-500">
                Complete {lessonsRemainingToUnlockLeaderboard} Mas lecciones
                {lessonsRemainingToUnlockLeaderboard === 1 ? "" : "s"} compite
              </p>
              <Link
              ...
              <div className="sticky top-0 -mt-14 flex w-full flex-col items-center gap-5 bg-white pt-14">
                ...
                <div className="flex w-full flex-col items-center gap-1 pb-5">
                  <p className="text-lg text-gray-500">
                    Los 20 mejores avanzan a la siguiente liga
                  </p>

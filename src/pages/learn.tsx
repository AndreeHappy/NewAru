                    ...
                    return (
                      ...
                      >
                        {tile.type === "fast-forward" && status === "LOCKED" ? (
                          ...
                          <HoverLabel text="Empezar" textColor={unit.textColor} />
                        ) : null}
                        <LessonCompletionSvg
                        ...
                        >
                          <TileIcon tileType={tile.type} status={status} />
                          <span className="sr-only">Mostrar Leccion</span>
                        </button>
                      </div>
                    );
                  case "treasure":
                    return (
                      <div
                        ...
                        aria-label={status === "ACTIVE" ? "Recolectar" : ""}
                      >
                        {status === "ACTIVE" && (
                          <HoverLabel text="Abierto" textColor="text-yellow-400" />
                        )}
                        <TileIcon tileType={tile.type} status={status} />
                      </div>
                    );
      ...
      <div className="flex justify-center gap-3 pt-14 sm:p-6 sm:pt-10 md:ml-24 lg:ml-64 lg:gap-12">
        <div className="flex max-w-2xl grow flex-col">
          ...
          <div className="sticky bottom-28 left-0 right-0 flex items-end justify-between">
            ...
            >
              <span className="sr-only">Practicar Ejercicios</span>
            ...
            {scrollY > 100 && (
              ...
              >
                <span className="sr-only">Saltar hasta arriba</span>
                <UpArrowSvg />
              </button>
            )}
          </div>

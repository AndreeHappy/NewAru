        ...
        <div className="flex justify-center gap-12">
          <div className="flex w-full max-w-xl flex-col gap-8">
            <p className="text-gray-400">
              ¡Entrenador aquí! Seleccionar un objetivo diario te ayudará a mantenerte motivado mientras aprendes un idioma. Puedes cambiar tu objetivo en cualquier momento.
            </p>
          ...
          <SettingsRightNav selectedTab="Editar Meta Diaria" />
        </div>
      </div>
    </div>
  );

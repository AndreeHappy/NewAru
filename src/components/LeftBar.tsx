...
export const LeftBar = ({ selectedTab }: { selectedTab: Tab | null }) => {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 top-0 hidden flex-col gap-5 border-r-2 border-[#e5e5e5] bg-white p-3 md:flex lg:w-64 lg:p-5" style={{background:"black"}}>
        <Link
          href="/learn"
        ...
        <ul className="flex flex-col items-stretch gap-3">
          ...
          >
            <LeftBarMoreMenuSvg />{" "}
            <span className="hidden text-sm lg:inline">Mas</span>
            <div
              className={[

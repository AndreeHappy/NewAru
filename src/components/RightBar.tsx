          ...
          >Diario
            ...
            >
              ...
              >
                ...
                <span className="text-gray-600">Añadir un nuevo curso</span>
              </Link>
            </div>
          </div>
          <span
          ...
          >
            ...
            >
              ...
              <p className="text-center text-sm font-normal text-gray-400">
                {`Pero tu racha se reiniciará mañana si no practicas mañana. ¡Cuidado!`}
              </p>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                <h2 className="text-xl font-bold text-black">Lingotes</h2>
                <p className="text-sm font-normal text-gray-400">
                  Tienes {lingots} {lingots === 1 ? "lingot" : "lingotes"}.
                </p>
                <Link
...
const UnlockLeaderboardsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
      <h2 className="text-xl font-bold">¡Desbloquea la clasificación!</h2>
      <div className="flex items-center gap-6">
        <LockedLeaderboardsSvg />
        <p className="text-sm leading-6 text-gray-500">
          Complete {lessonsNeededToUnlockLeaderboards} mas lecciones
          {lessonsNeededToUnlockLeaderboards === 1 ? "" : "s"} competir
        </p>
      </div>
    </article>
  );
    ...
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
      ...
      <div className="flex gap-6">
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-sm leading-6 text-gray-500">
            Ganaste {xpThisWeek} XP hasta ahora
          </p>
        </div>
      </div>
    </article>
...
const DailyQuestsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-gray-700">
      <h2 className="text-xl">Mision Diara</h2>
...
const XpProgressSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-gray-700">
      <div className="flex items-center justify-between">
        <h2 className="text-xl">Progreso XP</h2>
      ...
      <div className="flex gap-5">
        ...
        <div className="flex grow flex-col justify-around">
          <h3 className="font-normal text-gray-500">Meta Diaria</h3>
...
const CreateAProfileSection = ({
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold">
      <h2 className="text-xl">¡Crea un perfil para guardar tu progreso!</h2>
      <button
